...
var _user$project$PhotoGallery$loadPhotosCmd = A2(
	...
	_elm_lang$http$Http$getString(
		A2(_elm_lang$core$Basics_ops['++'], _user$project$PhotoGallery$urlPrefix, 'photos/list')));
		...
		switch (_p2.ctor) {
			...
			default:
				if (_p2._0.ctor === 'Ok') {
					...
					var photos = A2(_elm_lang$core$List$map, _user$project$PhotoGallery$Photo, urls);
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
